   ...
   UnityEvent ElementSetter_MyEvent; //  ElementSetter_MyEvent.Invoke();
        ...
        public void FillTelezka1(string vagName) // номер тележки 1 или 2
    {
        ...
        if (vagNames[2] == "Telezka1") { 
            ...
            int IdealCount = 0;
            if (IdealBaseItems[vagIndexList].TelezkaMezduputAbool1) IdealCount += 1; if (IdealBaseItems[vagIndexList].TelezkaKuvetAbool1) IdealCount += 1; if (IdealBaseItems[vagIndexList].TelezkaMezduputBbool1) IdealCount += 1;
            if (IdealBaseItems[vagIndexList].TelezkaKuvetBbool1) IdealCount += 1; if (IdealBaseItems[vagIndexList].UnderVagonbool1) IdealCount += 1; if (IdealBaseItems[vagIndexList].NearTheWagonbool1) IdealCount += 1;
    ...
    public void FillTelezka2(string vagName) // номер тележки 1 или 2
    {
        ...
        if (vagNames[2] == "Telezka2") {
            ...
            // сумму правильных ответов считаем и если больше порога то разрешаем
            int IdealCount = 0;
            if (IdealBaseItems[vagIndexList].TelezkaMezduputAbool2) IdealCount += 1; if (IdealBaseItems[vagIndexList].TelezkaKuvetAbool2) IdealCount += 1; if (IdealBaseItems[vagIndexList].TelezkaMezduputBbool2) IdealCount += 1;
            if (IdealBaseItems[vagIndexList].TelezkaKuvetBbool2) IdealCount += 1; if (IdealBaseItems[vagIndexList].UnderVagonbool2) IdealCount += 1; if (IdealBaseItems[vagIndexList].NearTheWagonbool2) IdealCount += 1;
